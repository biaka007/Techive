...
const Contact = () => {
  useEffect(() => {
    // Automatically redirect to WhatsApp when this page loads
    window.open('https://wa.me/524443113785', '_blank');
    // Optionally redirect back to home after a short delay
  ...
  return (
    <div className="pt-20 min-h-screen flex items-center justify-center">
      <div className="text-center">
        ...
        <h1 className="text-4xl font-bold mb-4 glow-text">Opening WhatsApp...</h1>
        <p className="text-xl text-gray-300 mb-8">
          We're redirecting you to WhatsApp to start the conversation.
        </p>
